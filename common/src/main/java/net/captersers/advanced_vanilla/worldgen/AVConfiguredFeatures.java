package net.captersers.advanced_vanilla.worldgen;
 ...
 * @since 1.0.0
 */
public class AVConfiguredFeatures {
    ...
    private static ResourceKey<ConfiguredFeature<?, ?>> resourceKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, AVMod.id(name));
    }
    ...
    public static void bootstrap(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        BlockState voidShardDefaultState = AVBlocks.VOID_SHARD.get().defaultBlockState();
