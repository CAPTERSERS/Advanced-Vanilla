 ...
 * @since 1.0.0
 */
public enum AVTiers implements Tier{
     ...
     *     <li>Incorrect Blocks: {@link AVBlockTags#INCORRECT_FOR_COPPER_TOOL}</li>
     * </ul>
     */
    COPPER(AVBlockTags.INCORRECT_FOR_COPPER_TOOL, 180, 5.0F, 1.5F, 8, Ingredient.of(Items.COPPER_INGOT)),
     ...
     *     <li>Repair Material: {@link AVItems#ENDERITE_INGOT}</li>
     *     <li>Incorrect Blocks: {@link AVBlockTags#INCORRECT_FOR_ENDERITE_TOOL}</li>
     * </ul>
     */
    ENDERITE(AVBlockTags.INCORRECT_FOR_ENDERITE_TOOL, 3120, 10.0F, 5.0F, 18, Ingredient.of(AVItems.ENDERITE_INGOT.get()));
     ...
     */
    AVTiers(TagKey<Block> incorrectBlockForDrops, int uses, float speed, float damage, int enchantmentValue, Ingredient repairIngredient) {
