 ...
 * @since 1.0.0
 */
public class AVSmithingTemplateItem {
    ...
    private static final Component ENDERITE_UPGRADE_APPLIES_TO = Component.translatable(Util.makeDescriptionId("item", AVMod.id("smithing_template.enderite_upgrade.applies_to"))).withStyle(DESCRIPTION);
    private static final Component ENDERITE_UPGRADE_INGREDIENTS = Component.translatable(Util.makeDescriptionId("item", AVMod.id("smithing_template.enderite_upgrade.ingredients"))).withStyle(DESCRIPTION);
    private static final Component ENDERITE_UPGRADE_BASE_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", AVMod.id("smithing_template.enderite_upgrade.base_slot_description")));
    private static final Component ENDERITE_UPGRADE_ADDITIONS_SLOT_DESCRIPTION = Component.translatable(Util.makeDescriptionId("item", AVMod.id("smithing_template.enderite_upgrade.additions_slot_description")));
    private static final Component ENDERITE_UPGRADE = Component.translatable(Util.makeDescriptionId("upgrade", AVMod.id("enderite_upgrade"))).withStyle(TITLE);
