 ...
 * @since 1.0.0
 */
public class AVFabricRecipeProvider extends FabricRecipeProvider {
     ...
     */
    public AVFabricRecipeProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> completableFuture) {
    ...
    public void buildRecipes(RecipeOutput exporter) {
        ...
        offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, AVItems.COPPER_NUGGET.get(), RecipeCategory.MISC, Items.COPPER_INGOT, "copper_nuggets_from_copper_ingot");
        offerReversibleCompactingRecipesWithReverseRecipeGroup(exporter, RecipeCategory.MISC, AVItems.ENDERITE_INGOT.get(), RecipeCategory.BUILDING_BLOCKS, AVBlocks.BLOCK_OF_ENDERITE.get(), "enderite_ingot_from_enderite_block");

        // Furnace recipes for smelting and blasting
        offerFurnaceRecipe(exporter, List.of(
                AVItems.COPPER_HELMET.get(),
                AVItems.COPPER_CHESTPLATE.get(),
                AVItems.COPPER_LEGGINGS.get(),
                AVItems.COPPER_BOOTS.get(),
                AVItems.COPPER_AXE.get(),
                AVItems.COPPER_PICKAXE.get(),
                AVItems.COPPER_SHOVEL.get(),
                AVItems.COPPER_HOE.get(),
                AVItems.COPPER_SWORD.get()), RecipeCategory.MISC, AVItems.COPPER_NUGGET.get(), 0.7F, 200, 100, "copper_nugget_from_copper_items");
        ...
        offerFurnaceRecipe(exporter, List.of(AVBlocks.VOID_SHARD.get()), RecipeCategory.MISC, AVItems.ENDERITE_SHARD.get(), 3.0F, 300, 100, "enderite_shard_from_void_shard");

        // Combat category recipes (armor and weapons)
        offerCopperRecipe(RecipeCategory.COMBAT, AVItems.COPPER_BOOTS.get(), 1, Items.COPPER_INGOT, "# #", "# #", "   ", exporter);
        offerCopperRecipe(RecipeCategory.COMBAT, AVItems.COPPER_CHESTPLATE.get(), 1, Items.COPPER_INGOT,"# #", "###", "###", exporter);
        offerCopperRecipe(RecipeCategory.COMBAT, AVItems.COPPER_HELMET.get(), 1, Items.COPPER_INGOT, "###", "# #", "   ", exporter);
        offerCopperRecipe(RecipeCategory.COMBAT, AVItems.COPPER_LEGGINGS.get(), 1, Items.COPPER_INGOT,"###", "# #", "# #", exporter);
        offerCopperToolRecipe(RecipeCategory.COMBAT, AVItems.COPPER_SWORD.get(), "C", "C", "S", exporter);

        // Enderite upgrade recipes (smithing table upgrades)
        offerEnderiteUpgradeRecipe(Items.NETHERITE_BOOTS, RecipeCategory.COMBAT, AVItems.ENDERITE_BOOTS.get(), exporter);
        offerEnderiteUpgradeRecipe(Items.NETHERITE_CHESTPLATE, RecipeCategory.COMBAT, AVItems.ENDERITE_CHESTPLATE.get(), exporter);
        offerEnderiteUpgradeRecipe(Items.NETHERITE_HELMET, RecipeCategory.COMBAT, AVItems.ENDERITE_HELMET.get(), exporter);
        offerEnderiteUpgradeRecipe(Items.NETHERITE_LEGGINGS, RecipeCategory.COMBAT, AVItems.ENDERITE_LEGGINGS.get(), exporter);
        offerEnderiteUpgradeRecipe(Items.NETHERITE_SWORD, RecipeCategory.COMBAT, AVItems.ENDERITE_SWORD.get(), exporter);

        // Misc category recipes
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AVItems.ENDERITE_INGOT.get(), 1)
                .pattern("DED")
                .pattern("EOE")
                .pattern("DED")
                .define('E', AVItems.ENDERITE_SHARD.get())
                .define('D', Items.DIAMOND)
                .define('O', Items.ENDER_EYE)
                .unlockedBy(hasItem(AVItems.ENDERITE_SHARD.get()), has(AVItems.ENDERITE_SHARD.get()))
                .unlockedBy(hasItem(Items.DIAMOND), has(Items.DIAMOND))
                .unlockedBy(hasItem(Items.ENDER_EYE), has(Items.ENDER_EYE))
                .save(exporter, AVMod.id(hasItem(AVItems.ENDERITE_INGOT.get())));

        // Redstone category recipes
        offerCopperRecipe(RecipeCategory.REDSTONE, AVBlocks.MEDIUM_WEIGHTED_PRESSURE_PLATE.get(), 1, Items.COPPER_INGOT, "##", "  ", "  ", exporter);

        // Tools category recipes
        offerCopperToolRecipe(RecipeCategory.TOOLS, AVItems.COPPER_AXE.get(), "CC", "CS", " S", exporter);
        offerCopperToolRecipe(RecipeCategory.TOOLS, AVItems.COPPER_HOE.get(), "CC", " S", " S", exporter);
        offerCopperToolRecipe(RecipeCategory.TOOLS, AVItems.COPPER_PICKAXE.get(), "CCC", " S ", " S ", exporter);
        offerCopperToolRecipe(RecipeCategory.TOOLS, AVItems.COPPER_SHOVEL.get(), "C", "S", "S", exporter);

        // Enderite tool upgrade recipes
        offerEnderiteUpgradeRecipe(Items.NETHERITE_AXE, RecipeCategory.TOOLS, AVItems.ENDERITE_AXE.get(), exporter);
        offerEnderiteUpgradeRecipe(Items.NETHERITE_HOE, RecipeCategory.TOOLS, AVItems.ENDERITE_HOE.get(), exporter);
        offerEnderiteUpgradeRecipe(Items.NETHERITE_PICKAXE, RecipeCategory.TOOLS, AVItems.ENDERITE_PICKAXE.get(), exporter);
        offerEnderiteUpgradeRecipe(Items.NETHERITE_SHOVEL, RecipeCategory.TOOLS, AVItems.ENDERITE_SHOVEL.get(), exporter);

        // Smithing template copying recipe
        copySmithingTemplate(exporter, AVItems.ENDERITE_UPGRADE_SMITHING_TEMPLATE.get(), Items.END_STONE);
    }
    ...
    protected static void offerReversibleCompactingRecipesWithReverseRecipeGroup(RecipeOutput output, RecipeCategory category, ItemLike item, RecipeCategory categoryCompress, ItemLike result, String name) {
        ...
        ShapedRecipeBuilder.shaped(categoryCompress, result)
                ...
                .save(output, AVMod.id(name + "_compress"));
        ...
        ShapelessRecipeBuilder.shapeless(category, item, 9)
                ...
                .save(output, AVMod.id(name + "_uncompress"));
    }
     ...
     * @see AVItems#ENDERITE_UPGRADE_SMITHING_TEMPLATE
    ...
    protected static void offerEnderiteUpgradeRecipe(ItemLike input, RecipeCategory category, ItemLike output, RecipeOutput exporter) {
        SmithingTransformRecipeBuilder.smithing(Ingredient.of(AVItems.ENDERITE_UPGRADE_SMITHING_TEMPLATE.get()), Ingredient.of(input), Ingredient.of(AVItems.ENDERITE_INGOT.get()), category, output.asItem())
                .unlocks(hasItem(AVItems.ENDERITE_INGOT.get()), has(AVItems.ENDERITE_INGOT.get()))
                .save(exporter, AVMod.id(hasItem(output)));
    }
