 ...
 * @since 1.0.0
 */
public class AVFabricWorldGeneratorProvider extends FabricDynamicRegistryProvider {
     ...
     */
    public AVFabricWorldGeneratorProvider(FabricDataOutput output, CompletableFuture<HolderLookup.Provider> registriesFuture) {
